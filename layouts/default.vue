<template>
  <div class="flex flex-col min-h-dvh" :class="[
    (route.path === '/en' || route.path === '/id' || route.path === '/') &&
    `lg:bg-[url('/background.png')] bg-[url('/Backgroundmobile.png')]  bg-cover lg:bg-center bg-left bg-no-repeat`,
  ]">
    <div class="relative col-span-12 lg:hidden" ref="target">
      <div id="navbar1" class="sticky top-0 w-full z-10" :class="[scrollStatus && 'bg-white']">
    ...
    <div id="navbar"
      class="sm:grid grid-cols-12 grid-rows-1 gap-4 lg:px-[160px] px-[20px] w-full hidden lg:block sticky top-0 z-20">
