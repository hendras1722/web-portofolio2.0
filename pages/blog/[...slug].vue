    ...
    <main class="pt-32 pb-24 px-6">
      <ContentDoc v-slot="{ doc }">
        <article class="max-w-4xl mx-auto">
          ...
          <!-- Post Footer -->
          <footer
            class="mt-24 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
...
useSeoMeta({
  ...
  ogSiteName: 'MSA',
  ogType: 'article',
  ogUrl: () => `https://syahendra.com/blog/${route.path}`,
  ogImage: '/me.png',
  twitterCard: 'summary_large_image',
  twitterImage: '/me.png',
  twitterSite: '@syahendra',
  twitterCreator: '@syahendra',
  twitterTitle: () => doc.value?.title ? `${doc.value.title} | MSA` : 'MSA - Journal',
  twitterDescription: () => doc.value?.description || 'Muh Syahendra Anindyantoro - Journal',
})
